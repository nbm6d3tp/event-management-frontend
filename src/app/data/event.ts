...
export const eventData: TEvent[] = [
  ...
  },
  {
    ...
    typeLocation: 'Hybrid',
    organizer: people[1],
    participations: [people[2], people[0]],
    reviews: [
      {
        id: 'review2',
        person: people[2],
  ...
  },
  {
    ...
    typeLocation: 'On-site',
    organizer: people[2],
    participations: [people[3], people[4], people[0]],
    reviews: [
      {
        id: 'review3',
        person: people[3],
  ...
  },
  {
    ...
    typeLocation: 'Remote',
    organizer: people[2],
    participations: [people[3], people[0]],
    reviews: [
      {
        id: 'review4',
        person: people[3],
  ...
  },
  {
    ...
    typeLocation: 'On-site',
    organizer: people[3],
    participations: [people[4], people[2], people[0]],
    reviews: [
      {
        id: 'review5',
        person: people[4],
  ...
  },
  {
    ...
    location: cities[6],
    organizer: people[0],
    participations: [people[3], people[4], people[2], people[1]],
    reviews: null,
  ...
  },
  {
    ...
    location: cities[7],
    organizer: people[0],
    participations: [people[4], people[3]],
    typeLocation: 'Hybrid',
    reviews: null,
    image: 'assets/event-images/event2.jpg',
  },
